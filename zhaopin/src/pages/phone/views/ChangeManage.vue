...
import Phone from '@/components/vant-form-readonly.vue'
...
export default class VantBindPhone extends Vue {
  ...
  checkFn (res: any) {
    ...
    const self = this
    this.checkAndEdit(this.beforephone, 1, res.code, function () {
      self.step = 2;
  ...
  changeFn (res: any) {
    ...
    this.checkAndEdit(res.phone, 2, res.code, () => {
      this.$goAnotherPage('/ent', 'replace')
    })
  }
}
</script>
